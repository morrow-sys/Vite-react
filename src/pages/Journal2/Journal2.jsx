...
// Функция безопасного парсинга HTML (как в Journal1)
...
function Journal2() {
  ...
  useEffect(() => {
    const fetchJournal = async () => {
      try {
        const res = await fetch(`${API_BASE_URL}/api/journals/by-abbreviation/ivk`, {
  ...
  const aboutText = journal.about?.[currentLang] || journal.about?.['ru'] || '';
